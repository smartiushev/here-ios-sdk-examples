...
class SettingsViewController: UITableViewController {
    ...
    var flowSwitch: UISwitch = UISwitch.init()
    var incidentSwitch: UISwitch = UISwitch.init()
    ...
    **/
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        {
            let mapSchemeCtrl = UISegmentedControl.init(items: Array(self.mapSchemes.keys))
        ...
        {
            let transitModeCtrl = UISegmentedControl.init(items: self.transitModes)
